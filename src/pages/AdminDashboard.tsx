...
import { Shield, AlertTriangle, CheckCircle, XCircle, RefreshCw, FileText, MessageSquare, Flag } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Manage reported content and moderation</p>
            </div>
          </div>
          <Button onClick={refreshAll} variant="outline" size="sm" disabled={contentLoading}>
